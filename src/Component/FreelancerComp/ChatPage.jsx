  ...
  return (
    <div className="flex  h-[calc(100vh-5px)] lg:pl-30 lg:pr-20 ">  
      ...
      <div className=" hidden lg:block mr-2 bg-white  rounded-2xl ">
        ...
        <div className="overflow-y-auto scrollbar-hide h-[calc(100vh-175px)]">
          {chatList.map((chat) => (
            <div 

              key={chat.id} 
              className={`flex items-center p-4 hover:bg-gray-50 cursor-pointer ${activeChat?.id === chat.id ? 'border-l-4 border-green-700 bg-gray-50' : ''}`}
        ...
        <div className="bg-white p-4 ">
          <form onSubmit={handleSendMessage} className="flex items-center">
            <input
              ...
              className="flex-1 border-none rounded-l-md outline-none py-2 px-4 focus:outline-none"
            />
            <button
                type="button"
                className="bg-white border-t border-r border-b p-2 text-gray-500 hover:text-gray-700"
