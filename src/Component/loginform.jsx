...
function Loginform() {  // Changed to capital L (React component naming convention)
    ...
    // REMOVED: return formik and console.log (these were in wrong place)
        ...
        <div className='mb-10 -mt-40 md:-mt-50 lg:-mt-80 md:pl-[100px] md:flex grid place-content-center '>
            ...
            <div className='md:w-[512px] w-full p-3 text-center md:pr-[100px] content-center'>
                ...
                <div className='pt-4 lg:pt-10 w-full '>
                    <form onSubmit={formik.handleSubmit}>  {/* REMOVED action='' */}
                        ...
                        <div className='mb-10'>
                            ...
                            {formik.touched.email && formik.errors.email ? (
                                <div className='grid place-content-start text-red-500'>{formik.errors.email}</div>
                            ) : null}
                        </div>
                        ...
                        <div className='mb-5'>
                            <div className='flex justify-between items-center'>
                                <input
                                    ...
                                    onBlur={formik.handleBlur}
                                />
                                <p onClick={togglePassword} className='ml-[-5vh] pr-[10px] text-xl cursor-pointer'>
                                    {showPassword ? <IoEyeSharp /> : <BsEyeSlashFill />}
                                </p>
                            </div>
                            {formik.touched.password && formik.errors.password ? (
                                <div className='grid place-content-start text-red-500'>{formik.errors.password}</div>
                            ) : null}
                        </div>
                        ...
                        <div className='flex justify-between pt-5'>
                            <div>
                                ...
                                <label htmlFor="" className='text-[#333333] font-bold font-normal pl-2 cursor-pointer'>
                                    Remember me
                                </label>
                            </div>
                            <div>
...
export default Loginform  // Changed to capital L