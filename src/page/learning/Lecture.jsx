                  ...
                  <div className='grid gap-4 mt-16 bg-gray-100 pb-10 h-full'>
                        ...
                        <div className='flex flex-col lg:flex-row  justify-between   pl-30 pr-20'>
                              ...
                              <div className='w-[60%] space-y-2'>
                                    ...
                                    <ul className="flex justify-evenly bg-white rounded-lg p-1 w-[60%]">
                                    ...
                                    <div className="rounded-lg w-[100%]" >
                                          <VideoCard imageurl={data.imageurl} title={data.title} topic={data.topic} lecturer={data.lecturer} duration={data.duration} rating={data.rating} progress={data.progress} />
                                    </div>


                              </div>
                              <div className=" px-12 bg-white rounded-xl">
